...
class ProcessDuePawnInterestCompoundingJob implements ShouldQueue
{
    ...
    public function handle(PawnInterestProcessService $service, DebtInterestFlowService $debtInterestFlowService, TenantBusinessLoanService $businessLoanService): void
    {
        app(OperationLogger::class)->run(
            self::class.'::handle',
            function () use ($service, $debtInterestFlowService, $businessLoanService): void {
