...
{
    protected $fillable = ['code', 'tenant_id', 'scope_key', 'exchange_rate_pair_id', 'rate', 'effective_date', 'observed_at', 'source', 'idempotency_key', 'is_void', 'voided_at', 'void_reason', 'created_by_tenant_user_id', 'created_by_platform_admin_id', 'voided_by_tenant_user_id', 'voided_by_platform_admin_id'];

    protected function casts(): array
    {
        return ['rate' => 'decimal:12', 'effective_date' => 'date', 'observed_at' => 'datetime', 'is_void' => 'boolean', 'voided_at' => 'datetime'];
    }
