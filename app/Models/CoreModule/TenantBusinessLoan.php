...
use Database\Factories\TenantBusinessLoanFactory;
...
class TenantBusinessLoan extends Model
{
    ...
    protected static function newFactory(): TenantBusinessLoanFactory
    {
        return TenantBusinessLoanFactory::new();
    }
    ...
    {
        return $this->belongsTo(TenantLender::class, 'lender_id')->withTrashed();
    }
    public function receiptAccount(): BelongsTo
    {
        return $this->belongsTo(FinancialAccount::class, 'receipt_account_id');
    }
    ...
    {
        return $this->hasMany(TenantBusinessLoanInterestAccrual::class, 'business_loan_id');
    }
    public function payments(): HasMany
    {
        return $this->hasMany(TenantBusinessLoanPayment::class, 'business_loan_id');
    }
