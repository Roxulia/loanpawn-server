...
return [
    ...
    */
    ...
    'defaults' => [
        ...
        'passwords' => env('AUTH_PASSWORD_BROKER', 'platformusers'),
    ],
    ...
    */
    ...
    'providers' => [
        'platformusers' => [
            'driver' => 'eloquent',
            'model' => App\Models\PlatformModule\PlatformUser::class,
        ],
        'platformadmins' => [
            'driver' => 'eloquent',
            'model' => App\Models\PlatformModule\PlatformAdmin::class,
        ],
        'tenantusers' => [
            'driver' => 'eloquent',
            'model' => App\Models\CoreModule\TenantUser::class,
        ],
