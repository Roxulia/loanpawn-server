...
return [
    'features' => [
        ...
        'business_loan_management' => [
            'name' => 'Business Loan Management',
            'description' => 'Manage tenant business loans and lender repayments.',
            'is_active' => true,
        ],
        'lender_management' => [
            'name' => 'Lender Management',
            'description' => 'Manage tenant lender identity records.',
            'is_active' => true,
        ],
